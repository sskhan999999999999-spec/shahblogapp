        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          <div className="hidden sm:block">
            <input
              type="text"
              placeholder="Search"
              className={` ${flag===true ?"rounded-full bg-gray-100 w-55 p-2 text-lg focus:outline-none focus:ring-2  hover:bg-white transition sm:focus:ring-green-400 focus:ring-green-400":"rounded-full bg-gray-100 w-55 p-2 text-lg focus:outline-none focus:ring-2 focus:ring-blue-400 hover:bg-white transition"}`}
            />
          </div>
